"""
Django settings for contra_backend project.
...
SECRET_KEY = 'django-insecure-ydxm20fohw0vpyx%l^g1%dc5jm3=$7%md4k88&_ic7(c)f(g42'
...
ROOT_URLCONF = 'contra_backend.urls'
...
WSGI_APPLICATION = 'contra_backend.wsgi.application'
